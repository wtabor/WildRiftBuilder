...
- Two Claude-driven GitHub Actions keep data honest: `data-verify.yml` (daily audit → corrections PR)
  and `data-backfill.yml` (batched roster fill). Keep their behavior in mind before duplicating work.
